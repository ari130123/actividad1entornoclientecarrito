...
class Carrito{
    ...
    */
    actualizarUnidades(SKU, lineCompra) {
        ...
        //HE TENIDO QUE CAMBIAR EL sku POR SKU que venía escrito porque en unos lados estaba en min y otras en mayus
    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            //bootstrap
            masButton.className = "btn btn-sm btn-success";
            ...
            //bootstrap 
            menosButton.className = "btn btn-sm btn-danger";
            ...
            cantidadInput.value = unidades;
            //bootstrap
            cantidadInput.className = "form-control form-control-sm text-center w-50";
    ...
    // nueva api 
    fetch("https://mocki.io/v1/64f1f8b7-4b3c-4f8a-830a-d7a48368311e")
